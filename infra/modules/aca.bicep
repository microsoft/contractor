...
param containerAppName string = 'contractor-containerapp'

@description('Container image (from ACR)')
param containerAppImage string = 'contractoracr.azurecr.io/myapp:latest'

@description('ACR name (used to assign pull role to env)')
param acrName string = 'contractoracr'

@description('ACR login server')
param acrLoginServer string = 'contractoracr.azurecr.io'
